...
class TestOptimizerConfig:
    ...
    def test_weight_decay_sets_optimizer_param_groups(self, optimizer: str) -> None:
        """PPO should pass weight decay through to every supported optimizer."""
        ppo, _ = _build_ppo(optimizer=optimizer, weight_decay=1.0e-4)
