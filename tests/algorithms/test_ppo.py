...
class TestOptimizerConfig:
    ...
    def test_weight_decay_override(self) -> None:
    ...
    def test_default_weight_decay_is_preserved(self) -> None:
        ...
        ppo, _ = _build_ppo(optimizer="adamw")
        reference = torch.optim.AdamW([torch.nn.Parameter(torch.zeros(()))])

        assert ppo.optimizer.defaults["weight_decay"] == reference.defaults["weight_decay"]
