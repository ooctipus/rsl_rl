...
from rsl_rl.modules import MLP, EmpiricalNormalization, commit_normalization
...
class StateCurriculum:
    ...
    def _build_success_estimator(self, cfg: dict) -> None:
        ...
        self._success_estimator.normalizer.accumulate(self._provider.state_features)
        commit_normalization((self._success_estimator,), self.distributed)
        self._predict_success_rates()
